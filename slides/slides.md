...
簽核之後檢驗單**永久鎖定**,要改只能作廢重開,每一步都留稽核紀錄。
...
- 現有 30 份標準 Excel<br/>將收斂成少數幾份類別標準
...
| 時程 | 項目 | 說明 |
|------|------|------|
| 本週 | **30 份檢驗標準入庫** | 現有 Excel 一次性遷移,逐份人工核對 |
| 本週 | **Excel 報表模板套版** | 拿到公司原版模板後,輸出 100% 一致 |
| 接著 | **正式部署** | 搬進客戶端主機,含帳號密碼強化 |
| 第二期 | 標準管理後台、統計儀表板 | 主管自行維護標準;月報數據一鍵出 |

</div>

<div class="mt-6 rounded-lg bg-green-500/10 p-4 text-sm text-green-400">
